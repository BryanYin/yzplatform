...
describe('Service Tests', () => {
    ...
    describe('YzTableStruct Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(YzTableStructService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/yz-table-structs';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return YzTableStruct', () => {

                let entity: YzTableStruct;
                service.find(123).subscribe((_entity: YzTableStruct) => {
                    entity = _entity;
                });
